...
namespace TheLongRun.Common.Events.IdentifierGroup
{
        ...
        : IEvent
    {
        ...
        /// <summary>
        /// The unique identifier of the instance excluded from the identifier group
        /// </summary>
        ...
        /// <summary>
        /// Additional commentary as to how this member became excluded
        /// </summary>
        public string Commentary { get; set; }

        public MemberExcluded(string aggregateKeyIn,
            DateTime asOfDateIn,
            uint asOfSequenceIn,
            string commentaryIn)
        {
